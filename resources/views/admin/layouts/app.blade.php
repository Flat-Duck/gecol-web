...
<body class="hold-transition skin-yellow-light sidebar-mini" dir="rtl">
    <div class="wrapper">
        {{-- Header --}}
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li {{ $page == 'office' ? ' class=active' : '' }}>
                        <a href="{{ route('admin.offices.index') }}">
                            <i class="fa fa-building"></i>
                            <span>إدارة مكاتب الجباية</span>
                        </a>
                    </li>
                    <li {{ $page == 'consumer' ? ' class=active' : '' }}>
                        <a href="{{ route('admin.consumers.index') }}">
                            <i class="fa fa-arrow-right"></i>
                            <span>إدارة المستهلكين</span>
                        </a>
                    </li>

                    <li {{ $page == 'counter' ? ' class=active' : '' }}>
                        <a href="{{ route('admin.counters.index') }}">
                            <i class="fa fa-tachometer"></i>
                            <span>إدارة العدادات</span>
                        </a>
                    </li>
                </ul>
            </section>
